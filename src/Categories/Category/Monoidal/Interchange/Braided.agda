...
swapʳ-natural {g = g} {h = h} {i = i} = begin
  (α⇐ ∘ id ⊗₁ σ⇒ ∘ α⇒) ∘ (g ⊗₁ h) ⊗₁ i    ≈⟨ pullʳ (pullʳ assoc-commute-from) ⟩
  α⇐ ∘ id ⊗₁ σ⇒ ∘ g ⊗₁ (h ⊗₁ i) ∘ α⇒      ≈⟨ refl⟩∘⟨ extendʳ (parallel id-comm-sym (braiding.⇒.commute _)) ⟩
  α⇐ ∘ g ⊗₁ (i ⊗₁ h) ∘ id ⊗₁ σ⇒ ∘ α⇒      ≈⟨ extendʳ assoc-commute-to ⟩
  (g ⊗₁ i) ⊗₁ h ∘ α⇐ ∘ id ⊗₁ σ⇒ ∘ α⇒      ∎
